...
from examples.mimo.configs.llava_vlm import (
...
def get_language_model_spec(
    num_layers, num_moe_experts, hidden_size, vocab_size, seq_len, pg_collection
):
...
def get_vision_submodules_spec(
    num_layers, num_moe_experts, hidden_size, language_hidden_size, pg_collection
):
...
def get_vlm_mimo_model(
    ...
    assert (
        global_world_size == vision_grid_size + language_grid_size
    ...
    vision_pg_collection, vision_grid, vision_expert_grid = _create_pg_collection(
        vision_tp,
        vision_pp,
        vision_cp,
        vision_ep,
    ...
    language_pg_collection, language_grid, language_expert_grid = _create_pg_collection(
        language_tp,
        language_pp,
        language_cp,
        language_ep,
